...
LS.Send.Popup = L.popup().setContent(
  '<div><input id="sendText" type="text" class="location-share" size="30" onkeyup="L.LocShare.Send.UpdateMessage( this )" placeholder="Inserisci nota"/></div><div style="height:35px;"><button class="location-share-btn" onclick="copyPrompt()">Crea URL</button></div></div>'
);
LS.Receive = {};
LS.Receive.Marker = {};
...
var sendIcon = L.icon({
  iconUrl:
    "https://raw.githubusercontent.com/CliffCloud/Leaflet.LocationShare/master/dist/images/IconMapSend.png",
...
receiveIcon = L.icon({
  iconUrl:
    "https://raw.githubusercontent.com/CliffCloud/Leaflet.LocationShare/master/dist/images/IconMapReceive.png",
  iconSize: [50, 50], // size of the icon
  iconAnchor: [25, 50], // point of the icon which will correspond to marker's location
  popupAnchor: [0, -30] // point from which the popup should open relative to the iconAnchor
});
...
L.Control.ShareLocation = L.Control.extend({
  ...
  onAdd: function() {
    ...
    userIcon.src =
      "https://raw.githubusercontent.com/CliffCloud/Leaflet.LocationShare/master/dist/images/IconLocShare.png";
    this.link.href = "#";
